...
if [[ ! -d ${ENV_PATH} ]]; then
    ...
    echo "Additionaly, the DB secret parameters are autoscaling provided in the ${ENV_PATH}/.secrets"
fi

# Local var definitions
KEY_NAME='ssh-key'
SEC_NAME='secrets.tfvars'
VAR_NAME='variables.tfvars'
CONF_NAME='backend.config'
SEC_PATH="${ENV_PATH}/.secrets"
KEY_FILE="${SEC_PATH}/${KEY_NAME}"
SEC_FILE="${SEC_PATH}/${SEC_NAME}"
VAR_FILE="${ENV_PATH}/${VAR_NAME}"
CONF_FILE="${ENV_PATH}/${CONF_NAME}"
